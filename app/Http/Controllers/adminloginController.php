...
class adminloginController extends Controller
{
    ...
    public function index()
    {
        if(Auth::guard('admin')->check()) 
        {
            ...
            $allbooks             = count(DB::table('books')->get());
            return view('admin.dashboard',compact('mainactive','subactive','logo','allmembers','allbooks','itemorders','allmessages','alltransfers','allcategories'));
        }
        else
        {
            $logo = setting::value('logo');
