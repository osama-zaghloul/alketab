                    ...
                    <table id="example3" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align:center;">مكان السلايدر</th>
                            ...
                            <tbody> 
                                @foreach($allsliders as $slider)
                                    <tr>
                                        <td><img style="width:100px;height:100px;" src="{{asset('users/images/'.$slider->image)}}" alt="{{$slider->title}}"></td>
                                        <td>{{$slider->artitle}}</td>
                                         <td>{{$slider->top ? 'ف الاعلى' : 'ف الاسفل'}}</td>
                                        <td>
