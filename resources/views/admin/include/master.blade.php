...
<body class="hold-transition skin-blue sidebar-mini sidebar-open">
 ...
 <header class="main-header" style="color:red">
...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        @endif
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>الكتب</span><i class="fa fa-angle-left pull-left"></i>
          </a>
          <ul class="treeview-menu">
            <li  @if($subactive=='addbook') class="active" @endif><a href="{{asset('adminpanel/books/create')}}"><i class="fa fa-circle-o"></i>اضافة كتاب</a></li>
            <li  @if($subactive=='book') class="active" @endif><a href="{{asset('adminpanel/books')}}"><i class="fa fa-circle-o"></i>كل الكتب</a></li>
          </ul>
          ...
          @endif
            ...
            <ul class="treeview-menu">
              <li  @if($subactive=='category') class="active" @endif><a href="{{asset('adminpanel/categories')}}"><i class="fa fa-circle-o"></i>أقسام الكتب</a></li>
              <li  @if($subactive=='wcategory') class="active" @endif><a href="{{asset('adminpanel/wcategories')}}"><i class="fa fa-circle-o"></i>التخصصات  </a></li>
            </ul>
        ...
        @endif
          ...
          <ul class="treeview-menu">
              <li  @if($subactive=='text') class="active" @endif><a href="{{asset('adminpanel/texts')}}"><i class="fa fa-circle-o"></i>النصوص</a></li>
