                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                            <div class="box box-info">
                                ...
                                <h3 class="box-title" >
                                   الشروط والاحكام باللغة العربية 
                                </h3>
                                </div>
                    ...
                    <div class="col-md-12">
                            <div class="box box-info">
                                ...
                                <div class="box-body pad">
                                    <textarea id="editor2" name="enconditions" rows="10" cols="80" required>{!! $cancelpolicy->enconditions !!}</textarea>
                                    @if ($errors->has('enconditions'))
                                        <div style="color: crimson;font-size: 18px;" class="error">{{ $errors->first('enconditions') }}</div>
                                    @endif
                                </div>
                            </div>
                    </div>
