...
Route::group(['middleware' => ['adminauth:admin']], function () {
  ...
  Route::resource('adminpanel/books', 'adminbookController');
  Route::delete('mybooksDeleteAll', 'adminbookController@deleteAll');
  Route::resource('adminpanel/provider', 'providerController');
  Route::resource('adminpanel/about', 'adminaboutController');
  Route::resource('adminpanel/texts', 'admintextController');
  ...
  Route::resource('adminpanel/wcategories', 'adminwcategoryController');
